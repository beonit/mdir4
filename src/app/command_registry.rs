...
impl Default for CommandRegistry {
    fn default() -> Self {
        ...
        commands.extend([
            command(
                Id::GitShortcutStatus,
                KeyChord::control(Key::Function(1)),
                "Git Status",
                None,
                true,
            ),
            command(
                Id::GitShortcutDiff,
                KeyChord::control(Key::Function(2)),
                "Git Diff Selection",
                None,
                true,
            ),
            command(
                Id::GitShortcutAdd,
                KeyChord::control(Key::Function(3)),
                "Git Add Selection",
                None,
                true,
            ),
            command(
                Id::GitShortcutUnstage,
                KeyChord::control(Key::Function(4)),
                "Git Unstage Selection",
                None,
                true,
            ),
            command(
                Id::GitShortcutCommit,
                KeyChord::control(Key::Function(5)),
                "Git Commit",
                None,
                true,
            ),
            command(
                Id::GitShortcutAmend,
                KeyChord::control(Key::Function(6)),
                "Git Commit Amend",
                None,
                true,
            ),
            command(
                Id::GitShortcutRebase,
                KeyChord::control(Key::Function(7)),
                "Git Rebase",
                None,
                true,
            ),
            command(
                Id::GitShortcutFetch,
                KeyChord::control(Key::Function(8)),
                "Git Fetch",
                None,
                true,
            ),
            command(
                Id::GitShortcutLog,
                KeyChord::control(Key::Function(9)),
                "Git Log",
                None,
                true,
            ),
            command(
                Id::GitShortcutStash,
                KeyChord::control(Key::Function(10)),
                "Git Stash Save",
                None,
                true,
            ),
            command(
                Id::GitShortcutBranches,
                KeyChord::control(Key::Function(11)),
                "Git Branches",
                None,
                true,
            ),
            command(
                Id::GitShortcutRefresh,
                KeyChord::control(Key::Function(12)),
                "Refresh Git Status",
                None,
                true,
            ),
...
fn command_id(name: &str) -> Option<CommandId> {
    ...
    Some(
        match name.to_ascii_lowercase().replace(['-', '_'], "").as_str() {
            ...
            "settings" => Settings,
            "gitstatus" => GitStatus,
            "gitshortcutstatus" => GitShortcutStatus,
            "gitshortcutdiff" => GitShortcutDiff,
            "gitshortcutadd" => GitShortcutAdd,
            "gitshortcutunstage" => GitShortcutUnstage,
            "gitshortcutcommit" => GitShortcutCommit,
            "gitshortcutamend" => GitShortcutAmend,
            "gitshortcutrebase" => GitShortcutRebase,
            "gitshortcutfetch" => GitShortcutFetch,
            "gitshortcutlog" => GitShortcutLog,
            "gitshortcutstash" => GitShortcutStash,
            "gitshortcutbranches" => GitShortcutBranches,
            "gitshortcutrefresh" => GitShortcutRefresh,
            _ => return None,
        },
    )
}
...
fn action(id: CommandId) -> Action {
    match id {
        ...
        CommandId::GitShortcutStatus | CommandId::GitShortcutRefresh => Action::ShowGitStatus,
        CommandId::GitShortcutDiff => Action::ShowSelectedGitDiff,
        CommandId::GitShortcutAdd => Action::GitStageBrowserSelection,
        CommandId::GitShortcutUnstage => Action::GitUnstageBrowserSelection,
        CommandId::GitShortcutCommit => Action::ShowGitCommit,
        CommandId::GitShortcutAmend => Action::ShowGitAmend,
        CommandId::GitShortcutRebase | CommandId::GitShortcutBranches => Action::ShowGitBranches,
